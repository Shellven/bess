...
<script type="text/javascript">
	...
	function view(authorityId) {
		...
		function(data) {
			$("#span1").html(data.authorityName);
			$("#span2").html(data.authorityContent);
			$("#span3").html(data.authorityLevel);
		},
		"json");
      ...
      <ul id="main-nav">
        ...
        <li> <a href="#" class="nav-top-item"> 消息管理 </a>
          <ul>
            ...
            <!-- <li><a href="rollout_check.html">转出审批</a></li>
            <li><a href="rollin_receive.html">转入接收</a></li>
            <li><a href="rollin_check.html">转入审批</a></li>
            <li><a href="#">查询统计</a></li>
        ...
        <li> <a href="#" class="nav-top-item"> 健康服务网 </a>
          <ul>
            ...
            <li><a href="medicalsecurity_manage.html">医疗保障服务</a></li>
          </ul>
        </li>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close1" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
			 ...
			 <br><br>
			  <input  style="display:none" class="text-input medium-input" type="text" id="d-insuredid" name="insuredId" />
			 <br><br>
